...
//! for merging worktrees and resolving conflicts, the HealthMonitor
//! for detecting stuck or failing agents, and the ReactivePlanner
//! for detecting plan changes and triggering replanning.
...
pub use planner::{PlanEvent, PlannerConfig, ReactivePlanner, TaskDiff, DEFAULT_DEBOUNCE_MS};
